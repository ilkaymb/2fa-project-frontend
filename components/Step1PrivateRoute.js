...
const Step1PrivateRoute = ({ children }) => {
  const [cookies] = useCookies(["STEP1_TOKEN"]); // Dinamik cookie ismi
  ...
  return cookies["STEP1_TOKEN"] ? children : null;
};

export default Step1PrivateRoute;
