...
export default function Home() {
  ...
  const [cookies, setCookie, removeCookie] = useCookies(["jwtToken"]); // userToken adında bir cookie yönetmek istiyorsunuz
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log(token);
      setCookie("jwtToken", token, { path: "/", maxAge: 600 }); // Cookie olarak kaydet
